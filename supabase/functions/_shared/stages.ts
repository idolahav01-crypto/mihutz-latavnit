...
import { callClaude, type ClaudeCallOptions, type ClaudeResult } from "./anthropic.ts";
import {
  type ApprovedFix,
  buildDiffs,
  type DetectedSignal,
...
// temperature 0.7 · input: present signals + site_profile + flagged code only
// ============================================================
...
// temperature 0.2 · input: touched files + approved fixes + design_direction
// ============================================================
...
// temperature 0 · NO prior-stage rationale is sent
// ============================================================
